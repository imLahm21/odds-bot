...
# ─── 微信公众号发布（/wxpublish 存草稿）──────────────────────────────────────
# 凭据从 .env 读（WECHAT_APPID/WECHAT_APPSECRET），此处仅放每场发布数（分页）。
# 默认封面图路径由 .env 的 WECHAT_DEFAULT_COVER 指定（草稿封面必填，兜底用）。
WXPUBLISH_DATES_PER_PAGE = int(os.getenv("WXPUBLISH_DATES_PER_PAGE", "8"))
...
# team_id → 中文队名（API-Football 英文名多为旧名/音译，中超球队近年频繁改名，
# 用稳定的 team_id 主键映射，不受英文名改动影响）。中超 16 队 + 足协杯全部 64 队。
# 只覆盖中国球队；查不到的（外国队/未收录）回退英文原名。
TEAM_ZH_NAMES: dict[int, str] = {
    # ── 中超 CSL（16 队）──
    830: "北京国安", 833: "上海申花", 836: "上海海港", 837: "天津津门虎",
    840: "河南队", 844: "山东泰山", 848: "浙江队", 1431: "青岛海牛",
    5648: "成都蓉城", 5684: "辽宁铁人", 5686: "深圳新鹏城", 5695: "武汉三镇",
    17265: "青岛西海岸", 21262: "重庆铜梁龙", 21263: "大连英博", 21265: "云南玉昆",
    # ── 足协杯其余（48 队）──
    834: "长春亚泰", 1439: "梅州客家", 1445: "黑龙江冰城", 2626: "南通支云",
    5647: "北京理工", 5652: "大连鲲城", 5660: "湖北青年星", 5665: "江西庐山",
    5679: "青岛红狮", 5688: "苏州东吴", 16619: "南京城市", 17263: "佛山南狮",
    17264: "石家庄功夫", 17269: "无锡吴钩", 17271: "延边龙鼎", 17272: "宜春威虎",
    19319: "南通海门珂缔缘", 19320: "绍兴上虞翼龙", 19321: "泰安天贶",
    20674: "西安崇德荣海", 21328: "日照宇启", 23132: "长春喜都",
    23135: "泉州青工", 23137: "广东蜀地红", 23145: "宁夏平罗恒利",
    23265: "深圳青年人", 23268: "广西恒宸", 23269: "广东广州豹",
    23270: "廊坊荣耀之城", 23286: "陕西联合", 25773: "广东铭途",
    25774: "广州蒲公英", 25775: "贵州筑城竞技", 25778: "上海泽天",
    25779: "深圳二零二八", 25780: "武汉联镇", 25781: "厦门诚毅",
    27556: "宁波首发", 27619: "上海同济", 27620: "大连科为", 27622: "厦门飞鹭",
    27680: "重庆瀚达", 27681: "贵州筑城栩烽堂", 27682: "聊城传奇",
    27683: "青岛追风少年", 27684: "云南爨合", 27702: "榆林草根矿工",
    27703: "北京鹏瑞",
}


def team_label(team_id: int | None, team_name: str | None) -> str:
    """把队名渲染成中文：team_id 命中 TEAM_ZH_NAMES 则用中文，否则回退英文原名。
    供 /fixtures、精算/复盘 meta、走地播报统一取中文队名。"""
    zh = TEAM_ZH_NAMES.get(team_id) if team_id is not None else None
    return zh or (team_name or "").strip()
